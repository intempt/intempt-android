...
import com.intempt.intempt_android.types.ConfigResult
import com.intempt.intempt_android.types.IntemptConfigs
import com.intempt.intempt_android.types.IntemptOptions
...
class ConfigManagerService  @Inject constructor(
    ...
    init {
        ...
        Log.d("ConfigManagerService: isTouchEnabled", "$isTouchEnabled")
        Log.d("ConfigManagerService: options?.isTouchEnabled", "${options?.isTouchEnabled}")
    }
